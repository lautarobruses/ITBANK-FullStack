...
const InputBlock = () => {
    ...
    if (type === 'text' || type === 'number' || type === 'email') {
        ...
        return  (
            <StyledPassword>
                <StyledInput type={type} id={id} value={input} name={id} required  onChange={({ target }) => setInput(target.value)}/>
                <button className="button-eye" type="button" value="Ver/Ocultar">
